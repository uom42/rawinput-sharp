...
public class HidValueState
{
	...
	public unsafe int? ScaledValue
	{
		...
		{
			fixed (void* preparsedData = Value.reader.PreparsedData)
				return HidP.TryGetScaledUsageValue ((IntPtr) preparsedData, HidPReportType.Input, Value.valueCaps, Value.UsageAndPage.Usage, report, reportLength, out var value)
					.Succeeded
					? value
					: null;
		}
