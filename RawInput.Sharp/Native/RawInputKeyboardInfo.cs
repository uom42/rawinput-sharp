...
public readonly struct RawInputKeyboardInfo
{
	...
	{
		return @$"dwType: {dwType}, 
dwSubType: {dwSubType}, 
dwKeyboardMode: {dwKeyboardMode}, 
dwNumberOfFunctionKeys: {dwNumberOfFunctionKeys}, 
dwNumberOfIndicators: {dwNumberOfIndicators}, 
dwNumberOfKeysTotal: {dwNumberOfKeysTotal}";
	}
}